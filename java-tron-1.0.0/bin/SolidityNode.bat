...
@rem ##########################################################################
@rem
@rem  SolidityNode startup script for Windows tron
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and SOLIDITY_NODE_OPTS to pass JVM options to this script.
...
@rem Execute SolidityNode
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SOLIDITY_NODE_OPTS%  -classpath "%CLASSPATH%" org.tron.program.SolidityNode %CMD_LINE_ARGS%
...
:fail
rem Set variable SOLIDITY_NODE_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%SOLIDITY_NODE_EXIT_CONSOLE%" exit 1
exit /b 1
