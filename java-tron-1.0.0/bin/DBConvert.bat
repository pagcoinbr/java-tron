...
@rem ##########################################################################
@rem
@rem  DBConvert startup script for Windows tron
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and DB_CONVERT_OPTS to pass JVM options to this script.
...
@rem Execute DBConvert
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %DB_CONVERT_OPTS%  -classpath "%CLASSPATH%" org.tron.program.DBConvert %CMD_LINE_ARGS%
...
:fail
rem Set variable DB_CONVERT_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%DB_CONVERT_EXIT_CONSOLE%" exit 1
exit /b 1
