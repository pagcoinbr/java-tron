...
@rem ##########################################################################
@rem
@rem  KeystoreFactory startup script for Windows tron
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and KEYSTORE_FACTORY_OPTS to pass JVM options to this script.
...
@rem Execute KeystoreFactory
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %KEYSTORE_FACTORY_OPTS%  -classpath "%CLASSPATH%" org.tron.program.KeystoreFactory %CMD_LINE_ARGS%
...
:fail
rem Set variable KEYSTORE_FACTORY_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%KEYSTORE_FACTORY_EXIT_CONSOLE%" exit 1
exit /b 1
